...
inputfile = r"D:\Doctool\python\工具脚本\file\UITy\Customizable SciFi Holo Interface_1.5.2.unitypackage"
outputDir = r'D:\Doctool\python\工具脚本\file\UITy'
# if len(sys.argv) > 2:
...
for i in os.listdir(outputDir):
	rootFile = os.path.join(outputDir, i)
	asset = i
...
for asset in mapping:
	...
	source = os.path.join(inputfile, asset, 'asset')
